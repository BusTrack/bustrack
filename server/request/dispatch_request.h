...
#ifndef BUSTRACK_DISPATCH_REQUEST_H_
#define BUSTRACK_DISPATCH_REQUEST_H_
...
namespace bustrack {
  ...
  public:
    /**
     * Constructs a DispatchRequest instance.
     *
     * @param context The server context.
     */
    DispatchRequest(ServerContext const* context) : Request(context) { };
...
#endif /* BUSTRACK_DISPATCH_REQUEST_H_ */
