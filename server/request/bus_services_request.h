...
#ifndef BUSTRACK_BUS_SERVICES_REQUEST_H_
#define BUSTRACK_BUS_SERVICES_REQUEST_H_
...
namespace bustrack {
   ...
   */
  class BusServicesRequest : public Request {
  public:
    /**
     * Constructs a BusServicesRequest instance.
     *
     * @param context The server context.
     */
    BusServicesRequest(ServerContext const* context) : Request(context) { };

    /**
     * We will always require the server context, so we disable the default
     * constructor.
     */
    BusServicesRequest() = delete;
...
#endif /* BUSTRACK_BUS_SERVICES_REQUEST_H_ */
