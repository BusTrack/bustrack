...
#ifndef BUSTRACK_BUS_STOPS_REQUEST_H_
#define BUSTRACK_BUS_STOPS_REQUEST_H_
...
namespace bustrack {
   ...
   */
  class BusStopsRequest : public Request {
  public:
    /**
     * Constructs a BusStopsRequest instance.
     *
     * @param context The server context.
     */
    BusStopsRequest(ServerContext const* context) : Request(context) { };

    /**
     * We will always require the server context, so we disable the default
     * constructor.
     */
    BusStopsRequest() = delete;
...
#endif /* BUSTRACK_BUS_STOPS_REQUEST_H_ */
